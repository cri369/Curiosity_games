...
export const CURIOSITY_DB: Question[] = [
  ...
  { q: "Qual è il metallo più abbondante nella crosta terrestre?", correct: ["Alluminio", "Al"], wrong: ["Rame", "Oro", "Argento", "Titanio"] },
  { q: "Quale organo umano consuma più energia?", correct: ["Cervello", "Fegato"], wrong: ["Cuore", "Polmoni", "Stomaco", "Reni"] },
  { q: "Qual è l'oceano più profondo?", correct: ["Pacifico", "Fossa delle Marianne"], wrong: ["Indiano", "Artico", "Antartico", "Mediterraneo"] },
  ...
  { q: "Qual è l'elemento chimico più leggero?", correct: ["Idrogeno", "H"], wrong: ["Litio", "Carbonio", "Ossigeno", "Azoto"] },
  { q: "Quale animale ha il cuore più grande?", correct: ["Balenottera azzurra", "Balena"], wrong: ["Giraffa", "Cavallo", "Gorilla", "Ippopotamo"] },
  ...
  { q: "Quale paese ha la forma di uno stivale?", correct: ["Italia", "Bel Paese"], wrong: ["Portogallo", "Cile", "Giappone", "Norvegia"] },
  { q: "Quale osso è il più piccolo del corpo umano?", correct: ["Staffa", "Orecchio"], wrong: ["Rotula", "Coccige", "Femore", "Falange"] },
  { q: "Quale sport è il più praticato al mondo?", correct: ["Calcio", "Nuoto"], wrong: ["Tennis", "Basket", "Cricket", "Golf"] },
  { q: "Quale materiale naturale è il più duro?", correct: ["Diamante", "Carbonio"], wrong: ["Quarzo", "Rubino", "Granito", "Topazio"] },
  { q: "Quale gas compone la maggior parte dell'atmosfera?", correct: ["Azoto", "N2"], wrong: ["Anidride carbonica", "Argon", "Elio", "Metano"] },
  { q: "Qual è il pianeta più caldo del sistema solare?", correct: ["Venere", "Secondo pianeta"], wrong: ["Marte", "Giove", "Saturno", "Terra"] },
  ...
  { q: "Qual è l'unico uccello che può volare all'indietro?", correct: ["Colibrì", "Hummingbird"], wrong: ["Rondine", "Passero", "Aquila", "Pappagallo"] },
  { q: "Quale paese ha inventato la pizza?", correct: ["Italia", "Napoli"], wrong: ["USA", "Cina", "Egitto", "Turchia"] },
  ...
  { q: "Qual è il muscolo più forte del corpo umano?", correct: ["Massetere", "Gluteo"], wrong: ["Bicipite", "Quadricipite", "Cuore", "Lingua"] },
  { q: "Quale città è chiamata la città eterna?", correct: ["Roma", "L'Urbe"], wrong: ["Parigi", "Londra", "Gerusalemme", "Il Cairo"] },
  { q: "Quante ossa ha un neonato rispetto a un adulto?", correct: ["Di più", "Circa 300"], wrong: ["Di meno", "Uguali", "La metà", "Zero"] },
  { q: "Qual è l'animale più veloce sulla terra?", correct: ["Ghepardo", "Cheetah"], wrong: ["Leone", "Cavallo", "Tigre", "Struzzo"] },
  { q: "Quale pianeta è conosciuto come il pianeta rosso?", correct: ["Marte", "Quarto pianeta"], wrong: ["Giove", "Saturno", "Urano", "Nettuno"] },
  { q: "Qual è la lingua più parlata al mondo?", correct: ["Inglese", "Cinese Mandarino"], wrong: ["Spagnolo", "Arabo", "Hindi", "Francese"] },
  ...
  { q: "Qual è l'oceano più piccolo?", correct: ["Artico", "Polo Nord"], wrong: ["Indiano", "Pacifico", "Atlantico", "Mediterraneo"] },
  { q: "Quale animale è il simbolo dell'Australia?", correct: ["Canguro", "Emu"], wrong: ["Koala", "Vombato", "Ornitorinco", "Dingo"] },
  { q: "Qual è il monte più alto del mondo?", correct: ["Everest", "Himalaya"], wrong: ["Kilimangiaro", "Monte Bianco", "Ande", "K2"] },
  ...
  { q: "Quale strumento misura la temperatura?", correct: ["Termometro", "Sensore termico"], wrong: ["Barometro", "Igrometro", "Anemometro", "Sismografo"] },
];
